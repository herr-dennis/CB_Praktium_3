...
public class MiniJava implements MiniJavaConstants {
  ...
  static final public void programm() throws ParseException {
    ...
    jj_consume_token(0);
                                               table.printTable(); codeErzeugung.print(); codeErzeugung.translateToOpcodes(); codeErzeugung.printByteCode();
  }
  ...
  static final public void constZuw() throws ParseException {
    ...
    jj_consume_token(NUMBER);
            table.addConst(ide, Integer.parseInt( token.image)); codeErzeugung.add("bipush "+table.getValue(ide)); codeErzeugung.add("istore "+table.getAddress(ide));
  }
  ...
  static final public void varZuw(String ide) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 22:
      jj_consume_token(22);
      jj_consume_token(NUMBER);
  ...
  static final public void statement() throws ParseException {
    ...
    case IDENT:
      jj_consume_token(IDENT);
           String ide = token.image;  if(table.getTyp(ide)=="const"){
    {if (true) try {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x100400,0x20,0x800000,0x40,0x400000,0x800000,0x18000,0x60000,0x102800,0x100400,};
   }
